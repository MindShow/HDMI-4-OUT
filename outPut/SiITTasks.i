...
#line 18 "sii9135\SiITTasks.c" /0
 
  
#line 1 "sii9135\SiITTHDCP.h" /0
...
#line 10 "sii9135\SiITTHDCP.h" /0
 
 
 BYTE siiGetHDCPStatus( void );
 
#line 19 "sii9135\SiITTasks.c" /0
...
#line 23 "sii9135\SiITTasks.c" /0
 ...
 siiSetNormalTerminationValueCh1(1);
 else
 siiSetNormalTerminationValueCh2(1);
 }
 }
 ...
 if ( SiI_Ctrl.bDevId == RX_SiI9135 || SiI_Ctrl.bDevId ==  RX_SiI9125){ 
 if(SiI_Ctrl.bVidInChannel==SiI_RX_VInCh1)
 siiSetNormalTerminationValueCh1(0);
 else
 siiSetNormalTerminationValueCh2(0);
 }
 ...
 SiI_Inf.bGlobStatus &= (~SiI_RX_Global_OldHotPlugDetect);
  ...
  bit CheckAudioTimeOut( WORD wTimeDiff ){
  bit qResult = 0;
 ...
 return qResult;
  ...
  bit CheckVideoTimeOut( WORD wTimeDiff ){
  bit qResult = 0;
 ...
 return qResult;
  ...
  bit CheckInfoFrameTimeOut( WORD wTimeDiff ){
  bit qResult = 0;
 ...
 switch ( bTaskSlot++ ) {
 case SiI_RX_TT_Video: siiTTVideoHandler( 0 );
 break;
 case SiI_RX_TT_Audio: siiTTAudioHandler( 0 );
 break;
 case SiI_RX_TT_InfoFrmPkt:
 break;
 case SiI_RX_TT_Sys:  TTSysTasksHandler();
 break;
 }
