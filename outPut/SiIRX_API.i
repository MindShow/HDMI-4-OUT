...
#line 26 "sii9135\SiIRX_API.c" /0
 ...
 SiI_Ctrl.bVidInChannel = bVideoInputChannels; 
 ...
 siiSetSM_ReqHoldAudioMuteAndStartMuting (1);
 else if( siiIsAudioHoldMuteState () )
 
 siiSetSM_ReqHoldAudioMuteAndStartMuting (0);
 if ( bAudioVideoMute & SiI_RX_AVMuteCtrl_MuteVideo )
 
 siiSetGlobalVideoMuteAndSM_Video ( 1  );
 else
 
 siiSetGlobalVideoMuteAndSM_Video ( 0  );
...
#line 180 "sii9135\SiIRX_API.c" /1
 
 
#line 182 "sii9135\SiIRX_API.c" /0
...
#line 192 "sii9135\SiIRX_API.c" /1
 
 
#line 194 "sii9135\SiIRX_API.c" /0
 ...
 pbRXParameters [0] = SiI_Ctrl.sm_bVideo;     
 pbRXParameters [1] = SiI_Ctrl.sm_bAudio;     
 ...
 siiPrepVideoPathSelect( bOutputVideoPathSelect, SiI_Inf.AVI.bInputColorSpace, abVidFormatData );
 ...
 AudioOutputFormat.wOutputSelect = SiI_Ctrl.wAudioOutputSelect = wAudioOutputSelect;
 ...
 pbRXParameters[1] = (BYTE)((SavedAudioOutputFormat.wOutputSelect >> 8 ) & 0xFF);
 pbRXParameters[2] = (BYTE)(SavedAudioOutputFormat.wI2SBusFormat & 0xFF);
 pbRXParameters[3] = (BYTE)((SavedAudioOutputFormat.wI2SBusFormat >> 8 ) & 0xFF);
