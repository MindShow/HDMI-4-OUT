...
#line 1 "sii9135\UDebugHLIIC.c" /0
...
#line 13 "sii9135\UDebugHLIIC.c" /0
...
#line 14 "sii9135\UDebugHLIIC.c" /0
...
#line 15 "sii9135\UDebugHLIIC.c" /0
...
#line 16 "sii9135\UDebugHLIIC.c" /0
 ...
 if(!(I2CCommand->Flags & 0x04)) {
 bState = GetI2CState();
 if(bState)
 return 1;
 bState = I2CSendAddr(I2CCommand->SlaveAddr,0x0);
 if(bState){
 I2CSendStop();
 return 2;
 }
 ...
 I2CCommand->RegAddrH++;
 if( ( I2CCommand->RegAddrL & 0x3f ) == 0 ){
 I2CSendStop();
 I2CSendAddr(I2CCommand->SlaveAddr,0x0);
 I2CSendByte(I2CCommand->RegAddrH);
 I2CSendByte(I2CCommand->RegAddrL);
 }
 }
 }
 if(!(I2CCommand->Flags & 0x02))
 I2CSendStop();
 ...
 I2CSendAddr (I2CCommand->SlaveAddr, 0x01);
 for ( i = 0; i < I2CCommand->NBytes-1; i++ )
 I2CCommand->Data[i]  = _I2CGetByte(0);
 if ( I2CCommand->Flags & 0x02 ) {
 I2CCommand->Data[i] = _I2CGetByte(0);
 }
 else {
 I2CCommand->Data[i] = _I2CGetByte(1);
 I2CSendStop();
 }
 return 0;
 ...
 BYTE BlockRead_16BAS ( I2CShortCommandType * IIC, BYTE * Data ) {
 BYTE i, bState;
 ...
 BYTE BlockWrite_16BAS( I2CShortCommandType * IIC, BYTE * Data ){
 BYTE i, bState;
...
#line 164 "sii9135\UDebugHLIIC.c" /1
...
#line 223 "sii9135\UDebugHLIIC.c" /0
 ...
 bState = I2CSendAddr (I2CCommand->SlaveAddr,0x01);
 if ( bState ) {
 I2CSendStop();
 return 2;
 }
