...
#line 1 "sii9135\SiITTInfoPkts.c" /0
...
#line 14 "sii9135\SiITTInfoPkts.c" /0
...
#line 15 "sii9135\SiITTInfoPkts.c" /0
...
#line 16 "sii9135\SiITTInfoPkts.c" /0
...
#line 17 "sii9135\SiITTInfoPkts.c" /0
...
#line 18 "sii9135\SiITTInfoPkts.c" /0
 ...
 static bit CheckACPInterruptAndClearIfSet( void ){
  bit qResult = 0;
 
 if( hlReadByte_8BA( 0x60, 0x7C ) & 0x04){
  hlWriteByte_8BA( 0x60, 0x7C, 0x04 );
 qResult = 1;
 }
 return qResult;
 ...
 siiReadBlockHDMIRXP1( 0xE0, 2, abInfoPkt);
 ...
 if ( ( abInfoPkt[0] != abOldInfoPkt[0] ) || ( abInfoPkt[1] != abOldInfoPkt[1] )) {
