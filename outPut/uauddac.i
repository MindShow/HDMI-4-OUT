...
#line 17 "sii9135\uauddac.c" /0
 ...
 void WakeUpAudioDAC ( void ) {
  ...
  hlWriteByte_8BA( 0x26, 0x02, 0x4F );
 ...
 void PowerDownAudioDAC( void ){
  ...
  hlWriteByte_8BA( 0x26, 0x02, 0x00 );
 ...
 if( bMode == SiI_RX_AudioRepr_DSD ){
  hlWriteByte_8BA( 0x26, 0x0A, 0x18 );
 }
 else {
  hlWriteByte_8BA( 0x26, 0x0A, 0x00 );
 }
