...
#line 14 "sii9135\SiIRXIO.c" /0
 ...
 I2CComm.SlaveAddr = 0x60;
 I2CComm.Flags = 0;
 I2CComm.NBytes = bNBytes;
 I2CComm.RegAddrL = bAddr;
 hlBlockRead_8BAS((I2CShortCommandType *)&I2CComm, pbData);
 }
 ...
 void siiModifyBits( BYTE bSlaveAddr, BYTE bRegAddr, BYTE bModVal, bit qSet ){
 BYTE bRegVal;
 ...
 hlWriteByte_8BA (bSlaveAddr, bRegAddr, (hlReadByte_8BA (bSlaveAddr, bRegAddr) & ~bBitMask) | bNewValue);
 }
