...
#line 14 "sii9135\SiISysCtrl.c" /0
...
#line 15 "sii9135\SiISysCtrl.c" /0
...
#line 16 "sii9135\SiISysCtrl.c" /0
...
#line 17 "sii9135\SiISysCtrl.c" /0
...
#line 18 "sii9135\SiISysCtrl.c" /0
...
#line 19 "sii9135\SiISysCtrl.c" /0
...
#line 20 "sii9135\SiISysCtrl.c" /0
...
#line 21 "sii9135\SiISysCtrl.c" /0
...
#line 22 "sii9135\SiISysCtrl.c" /0
...
#line 23 "sii9135\SiISysCtrl.c" /0
...
#line 24 "sii9135\SiISysCtrl.c" /0
 ...
 SiI_Inf.AVI.bOutputColorDepth=pbParameter[1];	 
 ...
 pbParameter[0] = SiI_Ctrl.bRXInitPrm0;        
 pbParameter[1] = SiI_Inf.AVI.bOutputColorDepth;	 
 ...
 BYTE siiInitilizeSystemData( bit qDoFromScratch ){
 BYTE bEWCode = 0;
 ...
 SiI_Ctrl.sm_bAudio = SiI_RX_AS_AudioOff;
  PDN = 1;
 PowerDownAudioDAC();
 SiI_Inf.bGlobStatus = SiI_RX_GlobalHDMI_NoAVIPacket | SiI_RX_Global_OldHotPlugDetect;
 }
 else {
 
 SiI_Inf.bGlobStatus = ~( SiI_RX_Global_HotPlugDetect | SiI_RX_GlobalHDMI_Detected
 | SiI_RX_GlobalHDMI_ACP | SiI_RX_GlobalHDMI_NoAVIPacket );
 
 }
 siiResetACPPacketData ( );
 SiI_Ctrl.sm_bVideo = SiI_RX_VS_PowerDown;
 SiI_Ctrl.wVideoTimeOut = 20; 
 ...
 wTicksDiff = wTicksNumber - SiI_Ctrl.SysTimer.wProcLastDoTasks_Ticks;
 else
 wTicksDiff = SiI_Ctrl.SysTimer.wProcLastDoTasks_Ticks - wTicksNumber;
 ...
 if ( wNewTimeInTicks > wStartTimeInTicks )   
 SiI_Ctrl.SysTimer.wProcLastAPI_Ticks = wNewTimeInTicks - wStartTimeInTicks;
 else
 SiI_Ctrl.SysTimer.wProcLastAPI_Ticks = ( 0xFFFF - wNewTimeInTicks ) + wStartTimeInTicks;
 }
 ...
 static BYTE bHDCPStatus = 0;
 static BYTE bGlobStatus = 0;
 ...
 void siiReInitRX( void ){
 BYTE abData[3];
 AudioOutputFormatType AudioOutputFormat;
 ...
 siiInitializeRX( abData );                      
 siiInitilizeSystemData( 0 );                  
